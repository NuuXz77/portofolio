...
<body class="premium-bg-root premium-bg-admin min-h-screen bg-base-200 text-base-content">
    ...
    <div id="admin-shell" class="relative z-10 min-h-screen">
        <div id="admin-sidebar-backdrop"
            class="fixed inset-0 z-30 bg-black/55 opacity-0 pointer-events-none transition-opacity duration-300 lg:hidden">
        </div>

        <aside id="admin-sidebar"
            class="glass-surface fixed inset-y-0 left-0 z-40 w-72 -translate-x-full border-r border-base-content/10 bg-base-100 px-4 py-5 shadow-xl transition-all duration-300 lg:translate-x-0">
