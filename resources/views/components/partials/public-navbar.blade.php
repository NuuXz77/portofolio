...
<header id="top" class="sticky top-0 z-50 px-4 pt-4 sm:px-8">
    <nav class="portfolio-glass glass-surface mx-auto flex max-w-7xl items-center justify-between rounded-2xl border border-base-content/15 px-4 py-3 shadow-2xl backdrop-blur-xl sm:px-6" aria-label="Primary navigation">
    ...
    <div id="mobile-menu-panel" class="portfolio-glass glass-surface mx-auto mt-2 max-h-0 max-w-7xl overflow-hidden rounded-2xl border border-transparent px-4 opacity-0 transition-all duration-300 lg:hidden">
        <div class="py-4">
